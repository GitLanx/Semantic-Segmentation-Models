...
parser.add_argument('--train_data', type=str, default='', help='Path for training images, using a matching pattern,e.g., "./images/*/*train.png"')
parser.add_argument('--train_labels', type=str, default='', help='Path for training labels, using a matching pattern, e.g., "./labels/*/*train.png"')
