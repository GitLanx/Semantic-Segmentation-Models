...
parser.add_argument('--val_epoch', type=int, default=10, help='How often to perform validation')
...
parser.add_argument('--n_classes', type=int, default=11, help='Number of classes, including void class or background')
